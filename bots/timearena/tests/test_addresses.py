...
def test_load_registry(tmp_path: Path) -> None:
    ...
    p.write_text(
        json.dumps(
            {
                "contracts": {
                    "TimeArena": "0xA51c1fc2f0D1a1b8494Ed1FE312d7C3a78Ed91C0",
                    "PodiumVaults": "0x0165878A594ca255338adfa4d48449f69242Eb8F",
                }
            }
        ),
        encoding="utf-8",
...
def test_load_registry_timecurve_alias(tmp_path: Path) -> None:
    ...
    ad = addresses_from_registry(load_registry_file(p))
    assert ad["time_arena"] == "0xA51c1fc2f0D1a1b8494Ed1FE312d7C3a78Ed91C0"
