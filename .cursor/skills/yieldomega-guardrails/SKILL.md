...
6f. **Referral CRED ([#253](https://gitlab.com/PlasticDigits/yieldomega/-/issues/253)):** **`ReferralCredApplied`** — **5% + 5%** of **`CRED_PER_BUY`** to referrer/buyer; no CHARM weight bonus; indexer **`idx_arena_referral_cred`**; **`/referrals`** CRED UI — [`referrals.md`](../../docs/product/referrals.md), [`INV-REFERRAL-253-CRED`](../../docs/testing/invariants-and-business-logic.md#referral-cred-split-gitlab-253).
