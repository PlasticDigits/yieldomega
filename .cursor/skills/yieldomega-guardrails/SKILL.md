...
1. Read `docs/agent-phases.md` for the matching phase, then [`docs/product/arena-v2.md`](../../docs/product/arena-v2.md) for Arena v2 economics and removals epic [#238](https://gitlab.com/PlasticDigits/yieldomega/-/issues/238).
...
9. **Frontend env:** `VITE_TIME_ARENA_ADDRESS`, `VITE_PODIUM_VAULTS_ADDRESS`, `VITE_ADMIN_SELL_VAULT_ADDRESS`; `VITE_TIMECURVE_ADDRESS` may alias arena until unified page [#256](https://gitlab.com/PlasticDigits/yieldomega/-/issues/256).
