...
- <a id="arena-buys-http-gitlab-282"></a>**Arena recent buys (`GET /v1/arena/buys`, schema ≥ 2.5.0, [GitLab #254](https://gitlab.com/PlasticDigits/yieldomega/-/issues/254), seconds field [#282](https://gitlab.com/PlasticDigits/yieldomega/-/issues/282)):** Paginated rows from **`idx_arena_buy`** (`limit` 1–200). Each item includes **`buyer`**, **`charm_wad`**, **`doub_paid`**, **`block_number`**, **`tx_hash`**, **`timer_hard_reset`**, **`paid_with_cred`**, and **`actual_seconds_added`** (decimal string — effective Last Buy timer extension from the onchain **`Buy`** log; not recomputed in the API). Values match ingest/DB for the same **`tx_hash`** / **`log_index`**. Map: **`INV-INDEXER-282-ARENA-BUYS-SECONDS`** · [`api_arena.rs`](../../indexer/src/api_arena.rs) · Anvil smoke: **`bash scripts/verify-wallet-profile-anvil.sh`** (dedicated **`ANVIL_PORT`** / **`INDEXER_PORT`** default **8548** / **3103**).
