...
**Fee routing:** Arena v2 uses per-buy DOUB splits via **`TimeArena`** / **`ArenaBuyRouting`** — not legacy five-sink CL8Y routing ([#244](https://gitlab.com/PlasticDigits/yieldomega/-/issues/244)). See [fee-routing-and-governance.md](fee-routing-and-governance.md).
