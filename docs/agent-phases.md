...
**Status:** Removed in Arena v2 ([#242](https://gitlab.com/PlasticDigits/yieldomega/-/issues/242)). Historical product spec was retired with v1 launchpad; do not implement Burrow deposit-withdraw. Doc cleanup: [#274](https://gitlab.com/PlasticDigits/yieldomega/-/issues/274).
...
**Docs:** [testing/strategy.md](testing/strategy.md) · [testing/ci.md](testing/ci.md) (CI ↔ local parity matrix)

**Goal:** Unit → devnet integration → testnet → production gates. Use **`docs/testing/ci.md`** for what runs in GitHub Actions vs local-only checks; do not re-propose a CI workflow — it already exists.
...
**Docs:** Root [`skills/README.md`](../skills/README.md) (index), plus product specs [product/arena-v2.md](product/arena-v2.md), [product/time-arena.md](product/time-arena.md), and [onchain/fee-routing-and-governance.md](onchain/fee-routing-and-governance.md). Retired v1 specs: [#241](https://gitlab.com/PlasticDigits/yieldomega/-/issues/241)–[#244](https://gitlab.com/PlasticDigits/yieldomega/-/issues/244).
