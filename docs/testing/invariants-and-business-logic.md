...
| **TimeCurve responsive layout containment ([GitLab #201](https://gitlab.com/PlasticDigits/yieldomega/-/issues/201))** | **`INV-FRONTEND-201-RESPONSIVE-LAYOUT`:** On phone widths, the Simple buy panel must not reserve desktop coin-stack side padding; it hides the decorative cutout, collapses the slider/input row, and keeps `scrollWidth <= viewport`. On tablet widths, Arena WarBow **Guard** / **Counterpunch Revenge** cards wrap headings and revenge rows, and TimeCurve spotlight padding no longer squeezes the action grid outside its panel. | [§201](#timecurve-responsive-layout-gitlab-201), [timecurve-views §201](../frontend/timecurve-views.md#timecurve-responsive-layout-gitlab-201), [`index.css`](../../frontend/src/index.css), [`timeCurveResponsiveLayoutCss.test.ts`](../../frontend/src/lib/timeCurveResponsiveLayoutCss.test.ts), [`timecurve.spec.ts`](../../frontend/e2e/timecurve.spec.ts), [manual QA (#201)](manual-qa-checklists.md#manual-qa-issue-201) |
