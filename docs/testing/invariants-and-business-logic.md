...
| **`INV-ARENA-PRIZE-ROUTING-300-25PCT`** | Each of 4 categories receives **25%** of buy (± remainder → Last Buy) ([#313](https://gitlab.com/PlasticDigits/yieldomega/-/issues/313)) | `ArenaPrizeRouting.t.sol`, `testFuzz_splitBuy_no_dust` |
