...
### TimeCurve protocol — DOUB projection card (GitLab #229)

**Intent:** [GitLab #229](https://gitlab.com/PlasticDigits/yieldomega/-/issues/229) — operators scanning **`/timecurve/protocol`** (AUDIT) get a prominent **DOUB projection** stat grid without expanding **Raw contract and operator context**.
...
**Spec ↔ test:** [`doubProjectionStats.test.ts`](../../frontend/src/lib/doubProjectionStats.test.ts) · [`timecurve.spec.ts`](../../frontend/e2e/timecurve.spec.ts) · [timecurve-views §229](../frontend/timecurve-views.md#timecurve-protocol-doub-projection-gitlab-229) · [manual QA (#229)](manual-qa-checklists.md#manual-qa-issue-229).
