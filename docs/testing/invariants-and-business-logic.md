...
| **TimeCurve — WarBow ladder snapshot drift + **`distributePrizes`** latch (#129)** | **`refreshWarbowPodium(candidates)`** (permissionless) re-applies live **`battlePoints`** heap updates and clears **`warbowPodiumFinalized`**. **`finalizeWarbowPodium(candidates)`** (`onlyOwner`, **ended**, **`!prizesDistributed`**) rebuilds the podium from **`bp > 0`** candidates and sets **`warbowPodiumFinalized`**. When **`reservePodiumPayoutsEnabled`** and the WarBow reserve slice is **non-zero**, **`distributePrizes`** requires **`warbowPodiumFinalized`** (**zero** pool unchanged). **Arena** maps a **Claim your WarBow position (refresh snapshot)** CTA via [`timeCurveWarbowSnapshotClaim.ts`](../../frontend/src/lib/timeCurveWarbowSnapshotClaim.ts) (sale-active heuristic). **Harness:** [`SimulateAnvilRichState.s.sol`](../../contracts/script/SimulateAnvilRichState.s.sol), [`verify-timecurve-post-end-gates-anvil.sh`](../../scripts/verify-timecurve-post-end-gates-anvil.sh). | [§ #129](#warbow-podium-snapshot-drifts-gitlab-129), [issue #129](https://gitlab.com/PlasticDigits/yieldomega/-/issues/129), [`play-timecurve-warbow/SKILL.md`](../../skills/play-timecurve-warbow/SKILL.md), [timecurve-views — #129](../frontend/timecurve-views.md#warbow-ladder-podium-snapshot-mismatch-issue-129) |
...
| **`INV-WARBOW-129-DIST`** | **`distributePrizes`**: when **`acceptedAsset.balanceOf(podiumPool) == 0`**, Returns early (**unchanged**). Otherwise **`reservePodiumPayoutsEnabled`** and **`warbowPodiumFinalized`** are **`require`**'d before paying winners. |
...
**Docs / play:** [timecurve-views — WarBow podium snapshot (#129)](../frontend/timecurve-views.md#warbow-ladder-podium-snapshot-mismatch-issue-129) · [`play-timecurve-warbow/SKILL.md`](../../skills/play-timecurve-warbow/SKILL.md).
