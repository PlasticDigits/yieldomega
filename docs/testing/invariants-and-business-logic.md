...
| **`/v1/status` fields** | **`ingestion_alive`**: **`true`** only in the **active** ingestion loop ( **`INGESTION_ENABLED`** on + non-empty registry addresses); **`false`** in API-only idle modes. **`last_indexed_at_ms`**: wall-clock millis after last successful block commit; **`0`** if never. Schema **`≥ 1.16.0`** ([`api.rs`](../../indexer/src/api.rs)). |
...
**Manual QA checklist (3rd-party agents):** [`manual-qa-checklists.md#manual-qa-issue-92`](manual-qa-checklists.md#manual-qa-issue-92) · [§ #106 — claim chain race](manual-qa-checklists.md#manual-qa-issue-106) · [§ #145 — claim error redaction](manual-qa-checklists.md#manual-qa-issue-145). **Anvil E2E:** [`anvil-presale-vesting.spec.ts`](../../frontend/e2e/anvil-presale-vesting.spec.ts) via [`scripts/e2e-anvil.sh`](../../scripts/e2e-anvil.sh).
