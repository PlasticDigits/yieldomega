...
**Automated:** Forge **`test_refreshWarbowPodium_reverts_after_endSale`** · Vitest **`timeCurveWarbowSnapshotClaim.test.ts`** · **`cargo test`** (`integration_stage2` WarBow routes).
