...
| **`INV-FRONTEND-362-WARBOW-VIEWER-SUMMARY-FLAG`** | When the viewer holds a planted WarBow flag (`showClaimFlagControl`), **`warbow-hero-card--viewer-summary`** shows a third **`FLAG:`** line (`data-testid="warbow-hero-viewer-summary-flag"`) with silence countdown or **claim now**; uses the same `flagSilenceEndSec` + `ledgerNowSec` math as the Flag subcard; no flag line when unplanted ([#362](https://gitlab.com/PlasticDigits/yieldomega/-/issues/362), parent [#360](https://gitlab.com/PlasticDigits/yieldomega/-/issues/360)) | `ArenaWarbowHeroPanel.test.tsx`, `warbowClaimFlagState.ts`, `cd frontend && npm run typecheck && npm test` · [arena-views §362](../frontend/arena-views.md#warbow-viewer-summary-flag-gitlab-362) · play skill [`play-time-arena-warbow`](../../skills/play-time-arena-warbow/SKILL.md) |
