...
| **`INV-ARENA-PRIZE-ROUTING-300-25PCT`** | Each of 4 categories receives **25%** of buy (± remainder → Last Buy) | `ArenaPrizeRouting.t.sol`, `testFuzz_splitBuy_no_dust`, `testFuzz_remainder_lands_on_cat0` ([#313](https://gitlab.com/PlasticDigits/yieldomega/-/issues/313)) |
