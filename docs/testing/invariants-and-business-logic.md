...
| **`INV-ARENA-PROGRESSION-LEVEL-CAP`** | `level` / `unlockedLevel` capped at **5**; XP banks at max | `test_level_cap_at_five`, `ArenaXp.t.sol::test_applyXpGain_banks_xp_at_max_level` ([#299](https://gitlab.com/PlasticDigits/yieldomega/-/issues/299)) · [detail §299](#arena-player-progression-gitlab-299) |
...
| ID | Property | Automated evidence |
|----|----------|-------------------|
| **`INV-ARENA-PROGRESSION-LEVEL-CAP`** | `MAX_PLAYER_LEVEL = 5`; surplus XP banks in `xpTowardNext` | `test_level_cap_at_five`, `ArenaXp.t.sol::test_applyXpGain_banks_xp_at_max_level` |
