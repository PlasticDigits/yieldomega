...
| #331 visual UX | Next-level locks ([#334](https://gitlab.com/PlasticDigits/yieldomega/-/issues/334)), L2+ celebration ([#335](https://gitlab.com/PlasticDigits/yieldomega/-/issues/335)), level history ([#336](https://gitlab.com/PlasticDigits/yieldomega/-/issues/336)), post-buy toasts ([#337](https://gitlab.com/PlasticDigits/yieldomega/-/issues/337)), while-you-were-away ([#338](https://gitlab.com/PlasticDigits/yieldomega/-/issues/338)) — happy + sad Vitest coverage ([#339](https://gitlab.com/PlasticDigits/yieldomega/-/issues/339)); Anvil play-feel E2E ([#340](https://gitlab.com/PlasticDigits/yieldomega/-/issues/340)) | Vitest: `arenaProgression.test.ts`, `arenaLevelUpCelebration.test.ts`, `LevelUpCelebrationPopover.test.tsx`, `WalletProfileModalSections.test.tsx`, `arenaBuyEffectToastLines.test.ts`, `ArenaEffectToastStack.test.tsx`, `WhileYouWereAwayModal.test.tsx`, `whileYouWereAwayActivity.test.ts`, `TimeArenaPage.test.tsx`, `ArenaSimplePage.test.tsx` · E2E: `e2e/anvil-arena-03-wallet-writes.spec.ts` ([#337](https://gitlab.com/PlasticDigits/yieldomega/-/issues/337)), `e2e/anvil-arena-05-play-feel.spec.ts` ([#340](https://gitlab.com/PlasticDigits/yieldomega/-/issues/340)) |

**E2E:** `e2e/arena.spec.ts`, `e2e/anvil-arena-*.spec.ts` (play-feel #331: `anvil-arena-03-wallet-writes.spec.ts`, `anvil-arena-05-play-feel.spec.ts`; indexer-first WYWA + level history need `YIELDOMEGA_E2E_INDEXER=1`) · **Unit:** `ArenaSimplePage.test.tsx`, `ArenaWarbowHeroPanel.test.tsx`, `ArenaCharmCredCard.test.tsx`, `arenaSaleSessionBuyPreflight.test.ts` ([#321](https://gitlab.com/PlasticDigits/yieldomega/-/issues/321)), #331 visual regression suite ([#339](https://gitlab.com/PlasticDigits/yieldomega/-/issues/339)) · **Manual:** [manual QA §291](manual-qa-checklists.md#manual-qa-issue-291), [§292](manual-qa-checklists.md#manual-qa-issue-292)
