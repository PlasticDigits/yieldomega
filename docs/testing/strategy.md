...
- **Simulations:** `simulations/` — `PYTHONPATH=. python3 -m unittest discover -s tests -v` for bounded repricing, faction comeback, and **DOUB sale calibration** (`test_doub_sale_calibration`, [issue #53](https://gitlab.com/PlasticDigits/yieldomega/-/issues/53)) — see [../simulations/README.md](../simulations/README.md), [../docs/simulations/README.md](../docs/simulations/README.md). Same command runs in the **`simulations-test`** job of [`.github/workflows/unit-tests.yml`](../../.github/workflows/unit-tests.yml).
