...
- **Simulations:** `simulations/` — `PYTHONPATH=. python3 -m unittest discover -s tests -v` for bounded repricing, faction comeback, and **EcoStrategy scenarios** ([GitLab #161](https://gitlab.com/PlasticDigits/yieldomega/-/issues/161) — `python3 -m ecostrategy`; see [../simulations/README.md](../simulations/README.md)). Same command runs in the **`simulations-test`** job of [`.github/workflows/unit-tests.yml`](../../.github/workflows/unit-tests.yml).
