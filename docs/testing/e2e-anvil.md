...
**Play checklist:** [`skills/verify-yo-bot-swarm-local-anvil/SKILL.md`](../../skills/verify-yo-bot-swarm-local-anvil/SKILL.md). **Invariants:** [§ #99 — Bot swarm + Anvil timing](invariants-and-business-logic.md#bot-swarm-anvil-interval-mining-issue-99).
