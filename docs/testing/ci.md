...
<a id="gitlab-github-ci-split-gitlab-322"></a>
...
# Production mock-wallet gate (#327) — expect non-zero exit
cd frontend && VITE_E2E_MOCK_WALLET=1 npm run build
