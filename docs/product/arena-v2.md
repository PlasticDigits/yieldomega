...
- **`buyWithCred`**: burns `charmWad × 100e18 / 1e18` CRED (no DOUB routing; adds **35 CRED** to epoch pool per buy) — [#268](https://gitlab.com/PlasticDigits/yieldomega/-/issues/268), [#311](https://gitlab.com/PlasticDigits/yieldomega/-/issues/311).
