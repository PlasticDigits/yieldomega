...
**Spec ↔ test:** `INV-ERC20-APPROVAL-143` · `INV-FRONTEND-224-CL8Y-APPROVE` · [`cl8yTimeCurveApprovalPreference.test.ts`](../../frontend/src/lib/cl8yTimeCurveApprovalPreference.test.ts) · [`ensureCl8yTimeCurveAllowance.test.ts`](../../frontend/src/lib/ensureCl8yTimeCurveAllowance.test.ts) · [arena-views](arena-views.md).
