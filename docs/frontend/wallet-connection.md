...
| **`TimeArena.buy`** / WarBow **CL8Y** pulls | **CL8Y** → **`TimeCurve` (proxy)** | **Exact** gross CL8Y needed for the pending tx (+ **50 bps** inclusion headroom unless unlimited opt-in) |
...
- ERC-20 **`approve` sizing** (exact vs opt-in unlimited CL8Y → TimeCurve): [§ GitLab #143](#erc20-approval-sizing-h-01-gitlab-143) · invariants — #143.
