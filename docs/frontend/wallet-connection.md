...
Participant-facing **wallet / contract identities** use [`AddressInline`](../../frontend/src/components/AddressInline.tsx) (blockie + label + link). Fee-sink monospace rows use [`MegaScannerAddressLink`](../../frontend/src/components/MegaScannerAddressLink.tsx), which shares the same URL builder. **Play:** [`skills/verify-yo-canonical-address-explorer/SKILL.md`](../../skills/verify-yo-canonical-address-explorer/SKILL.md); invariants: [§ #98](../testing/invariants-and-business-logic.md#canonical-address-display-gitlab-98).
