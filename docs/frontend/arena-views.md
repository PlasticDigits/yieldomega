...
| WarBow PvP | [`ArenaWarbowHeroPanel`](../../frontend/src/pages/arena/ArenaWarbowHeroPanel.tsx) | Steal / guard / revenge with live **`WARBOW_*_DOUB()`** cost pills (epoch-anchor-derived for steal/guard/revenge; fixed bypass) ([#252](https://gitlab.com/PlasticDigits/yieldomega/-/issues/252), [#367](https://gitlab.com/PlasticDigits/yieldomega/-/issues/367)); viewer summary shows BP, guard countdown, steal quota + UTC reset ([#361](https://gitlab.com/PlasticDigits/yieldomega/-/issues/361)), and planted-flag silence timer ([#362](https://gitlab.com/PlasticDigits/yieldomega/-/issues/362)) |
