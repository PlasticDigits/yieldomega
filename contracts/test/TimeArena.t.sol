...
contract TimeArenaTest is Test {
    ...
    function test_cred_only_buyer_fair_share() public {
        ...
        uint256 share = Math.mulDiv(70e18, 1e18, 2e18);
        ...
        assertEq(cred.balanceOf(alice), 1000e18 - 100e18 + share);
        assertEq(cred.balanceOf(bob), 1000e18 - 100e18 + share);
        assertLe(share * 2, 70e18);
    }
