...
- **Token / asset (issue #45 raster drafts, historic):** [`icons/token-cl8y.png`](../icons/token-cl8y.png), [`icons/token-doub.png`](../icons/token-doub.png), [`icons/token-charm.png`](../icons/token-charm.png), [`icons/token-usdm.png`](../icons/token-usdm.png). **Current product UI** imports constants from [`tokenMedia.ts`](../../../src/lib/tokenMedia.ts); CHARM/CRED render as inline SVG components and other canonical token art is served from [`public/tokens/`](../../tokens/) at `/tokens/…`. See the **Canonical token marks** section in [`frontend/public/art/README.md`](../README.md).
...
- **Time Arena sub-nav pictograms:** [`icons/nav-simple.png`](../icons/nav-simple.png), [`icons/nav-arena.png`](../icons/nav-arena.png), [`icons/nav-protocol.png`](../icons/nav-protocol.png).
