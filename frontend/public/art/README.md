...
| [`indexer-down-mascot.png`](./cutouts/indexer-down-mascot.png) | _staged_ | Soft illustration when recent buys cannot load from the indexer ([issue #57](https://gitlab.com/PlasticDigits/yieldomega/-/issues/57)). |
