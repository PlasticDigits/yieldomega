...
export function friendlyRevertMessage(raw: string): string {
  ...
  const map: [string, string][] = [
    ...
    ["timecurve: timer expired", "The round timer has expired."],
    ["timearena: timer expired", "The round timer has expired."],
    ...
    ["timecurve: not started", "Time Arena has not opened yet."],
    ["timearena: not started", "Time Arena has not opened yet."],
    ...
    ["timearenabuyrouter__badphase", "Time Arena is not open for Kumbaya buys right now (not started, paused, or past the timer)."],
