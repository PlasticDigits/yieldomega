...
export const timeArenaReadAbi = parseAbi([
  ...
  "function WARBOW_STEAL_VICTIM_MIN_MULT() view returns (uint256)",
  "function WARBOW_STEAL_VICTIM_MAX_MULT() view returns (uint256)",
  "function WARBOW_STEAL_ANCHOR_DIV() view returns (uint256)",
