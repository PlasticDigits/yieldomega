...
/** Mirrors onchain `TimeArena` WarBow DOUB constants (`PARAMETERS.md`). */
export const WARBOW_STEAL_DOUB_WAD = 1000n * 10n ** 18n;
export const WARBOW_GUARD_DOUB_WAD = 10_000n * 10n ** 18n;
export const WARBOW_STEAL_LIMIT_BYPASS_DOUB_WAD = 50_000n * 10n ** 18n;
export const WARBOW_REVENGE_DOUB_WAD = 1000n * 10n ** 18n;
