 ...
 * (`revertMessage.ts`) surfaces "TimeArena: revenge zero" when drain would be 0.
 */
 ...
 *   (see GitLab #236 acceptance criteria — "TimeArena: revenge zero" narrative).
 */
