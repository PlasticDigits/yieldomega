...
import { StatCard } from "@/pages/arena/arenaUi";
...
export type ArenaProtocolDoubProjectionSectionProps = {
...
function StatValueRow({
  ...
  return (
    <span className="arena-protocol__stat-value-row">
      {children}
...
export function ArenaProtocolDoubProjectionSection({
  ...
  readsPending,
  cl8yUsd,
}: ArenaProtocolDoubProjectionSectionProps) {
  ...
  return (
    <PageSection
      ...
      data-testid="arena-protocol-doub-projection"
    >
