...
import { envelopeCurveParamsFromWire, type EnvelopeCurveParamsWire } from "@/lib/timeArenaBuyDisplay";
...
import { ArenaLiveCharts } from "@/pages/arena/ArenaLiveCharts";
...
import { ArenaProtocolDoubProjectionSection } from "@/pages/arena/ArenaProtocolDoubProjectionSection";
...
import { useTimeCurveProtocolData } from "@/pages/arena/ArenaProtocolDataContext";

/**
 * Protocol view for `/arena/protocol` — a focused dump of authoritative
...
/** Last good ArenaLiveCharts inputs — avoids mount/unmount flicker while RPC refetch errors. */
  ...
  return (
    <div className="page arena-protocol-page">
      ...
      {protocolPhase !== "saleStartPending" && (
        <ArenaProtocolDoubProjectionSection
