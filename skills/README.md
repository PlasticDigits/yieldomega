...
**Entry point:** [Phase 20 in `docs/agent-phases.md`](../docs/agent-phases.md#phase-20) · Product spec: [`docs/product/arena-v2.md`](../docs/product/arena-v2.md)
...
| [`play-time-arena-doub/SKILL.md`](play-time-arena-doub/SKILL.md) | DOUB buys, Last Buy timer, podium funding split; vault funding indexer [#267](https://gitlab.com/PlasticDigits/yieldomega/-/issues/267). |
