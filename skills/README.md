...
- [Kumbaya integration — optional single-tx ETH/USDM entry](../docs/integrations/kumbaya.md#issue-65-single-tx-router) via **`TimeCurveBuyRouter`** + **`buyFor(..., plantWarBowFlag)`** onchain ([issue #65](https://gitlab.com/PlasticDigits/yieldomega/-/issues/65), [issue #63](https://gitlab.com/PlasticDigits/yieldomega/-/issues/63)); contributor test map: [invariants — TimeCurve `buyFor` row](../docs/testing/invariants-and-business-logic.md) · [WarBow flag opt-in](../docs/testing/invariants-and-business-logic.md#timecurve-warbow-flag-plant-opt-in-issue-63)
