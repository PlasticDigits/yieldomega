...
- [Kumbaya integration — optional single-tx ETH/USDM entry](../docs/integrations/kumbaya.md#issue-65-single-tx-router) via **`TimeCurveBuyRouter`** + **`buyFor(..., plantWarBowFlag)`** onchain ([issue #65](https://gitlab.com/PlasticDigits/yieldomega/-/issues/65), [issue #63](https://gitlab.com/PlasticDigits/yieldomega/-/issues/63)); indexer read-model for **`BuyViaKumbaya`** + enriched buys API ([issue #67](https://gitlab.com/PlasticDigits/yieldomega/-/issues/67)); contributor test map: [invariants — indexer `buyFor` / Kumbaya row](../docs/testing/invariants-and-business-logic.md) · [WarBow flag opt-in](../docs/testing/invariants-and-business-logic.md#timecurve-warbow-flag-plant-opt-in-issue-63)
...
- [Layered frontend audio (Album 1 BGM + `sound-effects/*.wav`)](../docs/frontend/sound-effects-recommendations.md#8-in-app-implementation-album-1--sfx-bus-issue-68) ([issue #68](https://gitlab.com/PlasticDigits/yieldomega/-/issues/68)) — UX-only; **no** onchain rule changes. Third-party agents describing “what you hear” should treat [`docs/frontend/sound-effects-recommendations.md`](../docs/frontend/sound-effects-recommendations.md) as product intent and the **invariants row** in [`docs/testing/invariants-and-business-logic.md`](../docs/testing/invariants-and-business-logic.md#timecurve-frontend-album-1-bgm-and-sfx-bus-issue-68) as the shipped wiring contract.
