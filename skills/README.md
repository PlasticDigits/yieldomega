...
- [Kumbaya integration — optional single-tx ETH/USDM entry](../docs/integrations/kumbaya.md#issue-65-single-tx-router) via **`TimeCurveBuyRouter`** + **`buyFor`** onchain ([issue #65](https://gitlab.com/PlasticDigits/yieldomega/-/issues/65)), **Simple + Arena** `buyViaKumbaya` when `timeCurveBuyRouter` is set ([issue #66](https://gitlab.com/PlasticDigits/yieldomega/-/issues/66)); Anvil **fork verification** script ([issue #78](https://gitlab.com/PlasticDigits/yieldomega/-/issues/78)) — [verify-yo-timecurve-buy-router-anvil](verify-yo-timecurve-buy-router-anvil/SKILL.md); indexer read-model for **`BuyViaKumbaya`** + enriched buys API ([issue #67](https://gitlab.com/PlasticDigits/yieldomega/-/issues/67)); contributor test map: [invariants — Kumbaya / single-tx / indexer](../docs/testing/invariants-and-business-logic.md)
