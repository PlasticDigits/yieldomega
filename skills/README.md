...
| [`verify-yo-timecurve-buy-charm-submit/SKILL.md`](verify-yo-timecurve-buy-charm-submit/SKILL.md) | TimeCurve **Buy CHARM** submit-time sizing ([issue #82](https://gitlab.com/PlasticDigits/yieldomega/-/issues/82)): fresh `currentCharmBoundsWad`, 99.5% max slack, CL8Y + Kumbaya single-tx — manual QA on a live-ticking chain. |
...
- [Kumbaya integration — optional single-tx ETH/USDM entry](../docs/integrations/kumbaya.md#issue-65-single-tx-router) via **`TimeCurveBuyRouter`** + **`buyFor`** onchain ([issue #65](https://gitlab.com/PlasticDigits/yieldomega/-/issues/65)), **Simple + Arena** `buyViaKumbaya` when `timeCurveBuyRouter` is set ([issue #66](https://gitlab.com/PlasticDigits/yieldomega/-/issues/66)); Anvil **fork verification** script ([issue #78](https://gitlab.com/PlasticDigits/yieldomega/-/issues/78)) — [verify-yo-timecurve-buy-router-anvil](verify-yo-timecurve-buy-router-anvil/SKILL.md); **submit-time CHARM sizing** ([issue #82](https://gitlab.com/PlasticDigits/yieldomega/-/issues/82)) — [verify-yo-timecurve-buy-charm-submit](verify-yo-timecurve-buy-charm-submit/SKILL.md), [invariants — #82](../docs/testing/invariants-and-business-logic.md#timecurve-buy-charm-submit-fresh-bounds-issue-82); indexer read-model for **`BuyViaKumbaya`** + enriched buys API ([issue #67](https://gitlab.com/PlasticDigits/yieldomega/-/issues/67)); contributor test map: [invariants — Kumbaya / single-tx / indexer](../docs/testing/invariants-and-business-logic.md)
