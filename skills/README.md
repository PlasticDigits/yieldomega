...
Fork and build workflows, Playwright-Anvil concurrency, indexer offline checks, referral rows, **`VITE_EXPLORER_BASE_URL`** / address links (**#98**), and related procedures: **[`docs/testing/manual-qa-checklists.md`](../docs/testing/manual-qa-checklists.md)** plus [`docs/testing/strategy.md`](../docs/testing/strategy.md) · [`docs/testing/e2e-anvil.md`](../docs/testing/e2e-anvil.md) · [`docs/testing/invariants-and-business-logic.md`](../docs/testing/invariants-and-business-logic.md).
