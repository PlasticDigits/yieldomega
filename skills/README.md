...
**Entry point:** [Phase 20 in `docs/agent-phases.md`](../docs/agent-phases.md#phase-20) · Product spec: [`docs/product/time-arena.md`](../docs/product/time-arena.md) · Implementation: [`docs/product/arena-v2.md`](../docs/product/arena-v2.md) · XP/level gas bounds: [GitLab #265](https://gitlab.com/PlasticDigits/yieldomega/-/issues/265) · [#245 invariants](../docs/testing/invariants-and-business-logic.md#arena-v2-play-skills-gitlab-245) · [`INV-TIME-ARENA-XP-GAS`](../docs/testing/invariants-and-business-logic.md)
...
| [`play-time-arena-doub/SKILL.md`](play-time-arena-doub/SKILL.md) | DOUB buys, Last Buy timer, podium funding split; optional **`topUpPodiumPools`** ([#261](https://gitlab.com/PlasticDigits/yieldomega/-/issues/261)); vault funding indexer [#267](https://gitlab.com/PlasticDigits/yieldomega/-/issues/267). |
