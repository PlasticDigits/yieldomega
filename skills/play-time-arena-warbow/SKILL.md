...
When [GitLab #252](https://gitlab.com/PlasticDigits/yieldomega/-/issues/252) lands, WarBow will spend **DOUB**, reset on WarBow epochs, and integrate with the four-podium model in [`docs/product/arena-v2.md`](../../docs/product/arena-v2.md).
