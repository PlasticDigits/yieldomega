...
Participant UI: **`/`** → [`ArenaWarbowHeroPanel.tsx`](../../frontend/src/pages/arena/ArenaWarbowHeroPanel.tsx) (`data-testid="warbow-hero-actions"`). The **viewer summary** card (`data-testid="warbow-hero-viewer-summary"`) shows YOUR BP, GUARD, **STEAL QUOTA** (`stealsCommittedByAttackerOnDay` / **`WARBOW_MAX_STEALS_PER_DAY`**) with UTC-day reset countdown ([#361](https://gitlab.com/PlasticDigits/yieldomega/-/issues/361)), and — when you hold a planted flag — **`FLAG:`** silence countdown or **claim now** ([#362](https://gitlab.com/PlasticDigits/yieldomega/-/issues/362) · **`INV-FRONTEND-362-WARBOW-VIEWER-SUMMARY-FLAG`** · [arena-views §362](../../docs/frontend/arena-views.md#warbow-viewer-summary-flag-gitlab-362)). Steal card shows **`describeStealPreflight`** above **Steal** before submit ([#361](https://gitlab.com/PlasticDigits/yieldomega/-/issues/361)). Cost pills read **`WARBOW_STEAL_DOUB`**, **`WARBOW_GUARD_DOUB`**, **`WARBOW_STEAL_LIMIT_BYPASS_DOUB`**, **`WARBOW_REVENGE_DOUB`** from the `TimeArena` proxy. Doc map: [arena-views § unified](../../docs/frontend/arena-views.md#unified-arena-page-gitlab-256) · **`INV-FRONTEND-256-UNIFIED-ARENA`** · **`INV-FRONTEND-361-WARBOW-STEAL-CAP-UX`**.
