...
- **Genesis / FDV anchor (docs):** **250M** total DOUB cap table and **$500k FDV** at **fully diluted** **250M** are summarized in [`contracts/PARAMETERS.md`](../../contracts/PARAMETERS.md) and [`docs/product/primitives.md`](../../docs/product/primitives.md) ([issue #53](https://gitlab.com/PlasticDigits/yieldomega/-/issues/53)). **v1** sale DOUB is a **fixed** `totalTokensForSale` balance; **mintable *k*** models are **planning-only** until contracts change ([`docs/simulations/README.md`](../../docs/simulations/README.md)).
