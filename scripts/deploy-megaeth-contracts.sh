...
DEFAULT_ARENA_CHARM_PRICE_WAD="1000000000000000000000"
...
ARENA_CHARM_PRICE_WAD="${ARENA_CHARM_PRICE_WAD:-$DEFAULT_ARENA_CHARM_PRICE_WAD}"
...
YieldOmega Arena v2 contracts deployment
  ...
  Charm price:   ${ARENA_CHARM_PRICE_WAD} wad
