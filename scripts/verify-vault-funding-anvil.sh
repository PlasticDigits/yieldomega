...
VERIFY_ANVIL_LOG=/tmp/yieldomega_verify267_anvil.log yieldomega_verify_start_anvil
...
yieldomega_verify_write_anvil_registry "${REGISTRY}" "verify-vault-funding-anvil.sh"
yieldomega_verify_pg_reset_db
yieldomega_verify_start_indexer /tmp/yieldomega_verify267_indexer.log
yieldomega_verify_wait_indexer_status die /tmp/yieldomega_verify267_indexer.log
