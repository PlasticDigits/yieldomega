...
# reset indexer DB → indexer → frontend/.env.local (chain 31337 + contract addresses + FeeRouter + indexer URL).
#
...
jq -n \
  ...
  '{
    ...
    chainId: $chainId,
    contracts: { TimeCurve: $tc, RabbitTreasury: $rt, LeprechaunNFT: $nft, FeeRouter: $fr },
